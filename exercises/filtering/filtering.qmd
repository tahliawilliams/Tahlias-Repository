...
maryland_first6_2024 <- maryland_first6_2024 |>
  arrange(date)

maryland_first6_2024 |>
  summarise(
    total_attempts = sum(sh_att),
    total_on_goal = sum(so_g),
    percent = (total_on_goal/total_attempts)*100
...
So far Maryland has signifigantly more wins this year. This year, they lost to James Madison while they had a draw in 2024. Maryland has also considerably more shots on goal and goals overall this season, indicating a stronger offensive performance. However, they've picked up more yellow cards which makes me think they have been a more aggressive style of play this season. Overall, Maryland's record has improves alot from last year, and it will be interesting to see how they do the rest of the season.  