...
I think it is best to focus on coaches who ended up as D1 head coaches so the story stays clear and shows the path that lead to the highest level of womens college basketball. Including D2 or D3 head coaches could be interesting, but that's combines different career paths and can make comparisons harder. Being a D3 head coach still shows leadership, and staying in D1 as an assistant usually comes with more prestige. Focusing on D1 head coaches would let us see real patterns and pipelines and you can always end up mentioning lower division paths shortly to show alternative routes. 
...
I think it depends on the scenario. If we were trying to highlight timelines and pathways to the highest level, it would make sense to only count their D1 experience so that were looking at schools that directly feed into Division I head coaching jobs. Using D2, D3, or other experience can be interesting for context, since it shows how coaches build leadership experiences in those lower divisions, but it can also be unneeded information if were only trying to focus on D1 pathways
...
1. "Pipeline Powerhouses" this would include focusing on schools like Mississippi State and Wake Forest, which produce the most future head coaches. It would be interesting to explore what makes these programs consistent deployers and determine if it is majority networking opportunities
2. "Mid-Major Movers" this could highlight mid programs and discuss how these schools provide unique opportunities for assistants to develop leadearship skills and move up the ranks
...
1. We should look at whether coaches who start as Staff vs Assistant Coaches reach coaching positions faster or slower 
